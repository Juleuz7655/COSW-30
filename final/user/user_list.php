...
echo "<table><thead><td class='center'>ID</td><td>First Name</td><td>Last Name</td><td>Email Address</td><td>Role</td><td>Team</td><td><img src='" . $row['photo'] . "' alt='User Photo' width='50'></td><td>Action</td></thead>"; // open table and include table headings
