...
<body>
    ...
    <p style="background: url(<?php echo $row['photo']; ?>); background-position: center; background-size: cover; border-radius: 50px; height: 100px; width: 100px">&nbsp;</p>
    <p><?php echo $row['first_name']  . ' ' . $row['last_name'] . ', ' . $row['role']; ?><br />
    <?php echo $row['email_address']; ?>, <?php echo $row['team']; ?></p>
