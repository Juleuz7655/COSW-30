...
$user = "dbcnl71nvynpuq"; //Your database username Does not change
$pass = "uaqco3xurnwhr"; // Your database user password
$db = "cosw30!LBCC"; //Your database name you want to connect to - add your number to the end of this
